...
from api.dtos import ImagePromptRequestBody
...
async def generate_prompt(prompt_request_body: ImagePromptRequestBody):
    ...
    try:
        ...
        return HTTPException(status_code=422, detail='Doesn\'t exist or not a valid image')
